...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_LAW = FREQ_LAW, // BlueMoon Fink added
	...
	RADIO_CHANNEL_INTEQ = FREQ_INTEQ, //BLUEMOON EDIT ADDITION - MAPPING
	RADIO_CHANNEL_GHOST_INTEQ = FREQ_GHOST_INTEQ, //BLUEMOON EDIT ADDITION - MAPPING
	RADIO_CHANNEL_SOL = FREQ_SOL, // BlueMoon Kovac added
	RADIO_CHANNEL_NRI = FREQ_NRI, // BlueMoon Kovac added
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_LAW]" = RADIO_CHANNEL_LAW, //BlueMoon Fink added
	"[FREQ_CENTCOM]" = RADIO_CHANNEL_CENTCOM,
	"[FREQ_PIRATE]" = RADIO_CHANNEL_PIRATE, //BLUEMOON EDIT ADDITION - MAPPING
	"[FREQ_INTEQ]" = RADIO_CHANNEL_INTEQ, //BLUEMOON EDIT ADDITION - MAPPING
	"[FREQ_GHOST_INTEQ]" = RADIO_CHANNEL_GHOST_INTEQ, //BLUEMOON EDIT ADDITION - MAPPING
	...
	"[FREQ_NRI]" = RADIO_CHANNEL_NRI, //BlueMoon Kovac added
