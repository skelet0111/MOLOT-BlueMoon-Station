/datum/action/innate/clockwork
	...
	check_flags = AB_CHECK_RESTRAINED|AB_CHECK_STUN|AB_CHECK_CONSCIOUS|AB_CHECK_CONSCIOUS
...
/datum/action/innate/clockwork/comm
	...
	check_flags = AB_CHECK_CONSCIOUS|AB_CHECK_CONSCIOUS
...
/datum/action/innate/clockwork/check_progress/IsAvailable()
	if(is_servant_of_ratvar(owner) || isobserver(owner))
		return TRUE
	return FALSE
