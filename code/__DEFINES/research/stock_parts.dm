...
#define STANDARD_PART_LEVEL_LATHE_COEFFICIENT(level)		clamp(1 - ((level - 1)  * 0.125), 0, 1)
...
#define STANDARD_PART_LEVEL_ORE_COEFFICIENT(level)			clamp(1 + ((level - 1) * 0.25), 1, 10)
