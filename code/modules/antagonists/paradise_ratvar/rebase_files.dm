// 1. Удалить всё, что связано с Ратваром.
// 1.1. Исключение номер один. Танки Ратвара и Призыватель Танков Ратвара.
// 1.2. Исключение номер два. Портальный Шторм Ратвара.
// 1.3. Исключение номер три. Дредноут-Мех Ратвара.
// 2. Перенести все связанные с Ратваром файлы с Парадиза.
// 3. Запустить билд.
// 4. Записать ошибки.
// 5. Пройтись по ошибкам.
// 6. Запустить Билд и попробовать поиграть.
// 7. Пройтись по ошибкам.
// 8. Пустить в Тест-Мёрдж.
// 9. Пройтись по ошибкам.
// 10. ???
