...
/obj/structure/crate_shelf
	...
	icon = 'modular__juicy/icons/obj/structures/objects.dmi'
...
/obj/structure/crate_shelf/Initialize()
	...
	for(var/i in 1 to (capacity - 1))
		...
		overlays += image(icon = 'modular__juicy/icons/obj/structures/objects.dmi', icon_state = "shelf_stack", layer = stack_layer, pixel_y = stack_offset)
	return
