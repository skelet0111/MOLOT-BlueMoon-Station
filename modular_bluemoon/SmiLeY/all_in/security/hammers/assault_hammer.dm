/obj/item/melee/breaching_hammer
	...
	icon = 'modular_bluemoon/SmiLeY/all_in/security/hammers/assault_items.dmi'
	icon_state = "assault_hammer"
	item_state = "assault_hammer"
	lefthand_file = 'modular_bluemoon/SmiLeY/all_in/security/hammers/assault_baton_lefthand.dmi'
	righthand_file = 'modular_bluemoon/SmiLeY/all_in/security/hammers/assault_baton_righthand.dmi'
