...
/proc/send_raider_threat()
	...
	threat_msg.answer_callback = CALLBACK(GLOBAL_PROC, PROC_REF(raiders_answered), threat_msg, payoff, ship_name, initial_send_time, response_max_time, ship_template)
